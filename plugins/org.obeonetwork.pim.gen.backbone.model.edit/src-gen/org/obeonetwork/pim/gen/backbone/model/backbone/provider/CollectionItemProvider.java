...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.pim.gen.backbone.model.backbone.Collection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Collection_model_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Collection_model_feature", "_UI_Collection_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 BackbonePackage.Literals.COLLECTION__MODEL,
				 true,
				 false,
				 true,
				 null,
