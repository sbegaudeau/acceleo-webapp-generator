...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.tutorial.webapp.CheckBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckBoxItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CheckBox_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CheckBox_description_feature", "_UI_CheckBox_type"),
				 WebappPackage.Literals.CHECK_BOX__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CheckBox.class)) {
			case WebappPackage.CHECK_BOX__DESCRIPTION:
