...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.tutorial.webapp.Section} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebappPackage.Literals.SECTION__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Section_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Section_description_feature", "_UI_Section_type"),
				 WebappPackage.Literals.SECTION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebappPackage.Literals.SECTION__WIDGETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.SECTION__WIDGETS,
				 WebappFactory.eINSTANCE.createForm()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.SECTION__WIDGETS,
				 WebappFactory.eINSTANCE.createTable()));
		...
		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.SECTION__WIDGETS,
				 WebappFactory.eINSTANCE.createVideo()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.SECTION__WIDGETS,
				 WebappFactory.eINSTANCE.createGallery()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.SECTION__WIDGETS,
				 WebappFactory.eINSTANCE.createImagesBlock()));
	}
