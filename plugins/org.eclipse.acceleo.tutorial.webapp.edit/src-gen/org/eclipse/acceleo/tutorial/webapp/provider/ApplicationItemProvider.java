...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.tutorial.webapp.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.APPLICATION__ROUTER,
				 WebappFactory.eINSTANCE.createRouter()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.APPLICATION__COLLECTIONS,
				 WebappFactory.eINSTANCE.createCollection()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.APPLICATION__VIEWS,
				 WebappFactory.eINSTANCE.createModelView()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.APPLICATION__VIEWS,
				 WebappFactory.eINSTANCE.createStaticView()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.APPLICATION__MODELS,
