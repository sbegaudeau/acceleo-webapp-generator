...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.pim.gen.bootstrap.model.bootstrap.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BootstrapPackage.Literals.FORM__FORM_WIDGETS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Form.class)) {
			case BootstrapPackage.FORM__FORM_WIDGETS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.FORM__FORM_WIDGETS,
				 BootstrapFactory.eINSTANCE.createTextArea()));

		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.FORM__FORM_WIDGETS,
				 BootstrapFactory.eINSTANCE.createSpinner()));

		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.FORM__FORM_WIDGETS,
				 BootstrapFactory.eINSTANCE.createCheckBox()));
	}
