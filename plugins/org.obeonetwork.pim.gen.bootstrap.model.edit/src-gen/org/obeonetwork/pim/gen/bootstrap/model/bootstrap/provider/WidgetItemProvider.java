...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.pim.gen.bootstrap.model.bootstrap.Widget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WidgetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Widget_title_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Widget_title_feature", "_UI_Widget_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 BootstrapPackage.Literals.WIDGET__TITLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Widget)object).getTitle();
		return label == null || label.length() == 0 ?
			getString("_UI_Widget_type") : //$NON-NLS-1$
