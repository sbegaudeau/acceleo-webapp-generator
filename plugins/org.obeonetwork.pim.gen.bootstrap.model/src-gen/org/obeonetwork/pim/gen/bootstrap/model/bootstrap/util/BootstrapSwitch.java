...
public class BootstrapSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BootstrapPackage.MAIN_PAGE: {
				MainPage mainPage = (MainPage)theEObject;
				T result = caseMainPage(mainPage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BootstrapPackage.SECTION: {
				Section section = (Section)theEObject;
				T result = caseSection(section);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BootstrapPackage.WIDGET: {
			...
			case BootstrapPackage.IMAGES_BLOCK: {
			...
			case BootstrapPackage.CHECK_BOX: {
